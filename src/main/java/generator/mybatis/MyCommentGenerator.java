...
/**
 * Created by 草帽boy on 2017/2/16. <br>
 * mybatis generator 自定义comment生成器. <br>
 * 基于MBG 1.3.2.
 */
...
public class MyCommentGenerator implements CommentGenerator {
  ...
  public MyCommentGenerator() {
    ...
    suppressDate = true; // 去掉自动生成的无意义注释
    suppressAllComments = true; // 去掉自动生成的无意义注释
