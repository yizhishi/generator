...
public class DatabaseOption {
	...
	// 模板文件
	private final String[] templates = { "domain.vm", "mapper.vm", "mapperInterface.vm" };

	// 输出路径
	private final String[] paths = { Config.getProperty("domainPackage"), Config.getProperty("mapperPackage"),
			Config.getProperty("mapperPackage") };

	// 生成文件后缀
	private final String[] fileNames = { ".java", "Mapper.xml", "Mapper.java" };

	private List<TableMetadata> getTableMetas()
			throws InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException {

		System.out.println("begin connect database....");

		Class.forName(Config.getProperty("driver"));
		Connection conn = DriverManager.getConnection(Config.getProperty("url"), Config.getDatabaseProperty());
